<script lang="ts">
	...
	const BASE_URL =
		"https://greasyfork.org/scripts/407846-mcbbs-creditanalysis/code/MCBBS%20CreditAnalysis.user.js";
...
{:else if state == "confirm"}
	<Section>
		...
		<p>
			如果选择继续，则本页面会分别下载<a href={BASE_URL}
				>MCBBS CreditAnalysis</a
			>和<a href={PATCH_URL}>洞穴夜莺补丁</a>，然后将补丁打到MCBBS
			CreditAnalysis上。
		</p>
		<p>
			需要<a href="https://www.tampermonkey.net/">TamperMonkey</a
			>浏览器插件才能使用MCBBS
			CreditAnalysis。由于技术原因，此类由网页生成的脚本无法打开TamperMonkey的安装界面。因此，在下载完成后需要您手动将脚本复制粘贴到TamperMonkey的“添加新脚本”页面（可在TamperMonkey主菜单中找到）中去安装。
		</p>
